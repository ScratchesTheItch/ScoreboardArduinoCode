...
class HT1632LEDMatrix : public Print {
 ...
 uint8_t height();
  ...
  void drawSkinnyChar(uint8_t x, uint8_t y, char c, uint16_t color, uint8_t size);
  void drawSideChar(uint8_t x, uint8_t y, char c, uint16_t color, uint8_t size);
  void drawSideSkinnyChar(uint8_t x, uint8_t y, char c, uint16_t color, uint8_t size);
